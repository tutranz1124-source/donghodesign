...
export default function AdminPageEditor() {
  ...
  return (
    <div className="p-3 sm:p-5 max-w-[1760px] mx-auto space-y-4 transition-all font-sans text-[12.5px]">
      ...
      {/* Top Action Bar */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-white p-4 sm:p-5 rounded-2xl border border-[#e2ddd3] shadow-xs">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="text-[10.5px] font-bold text-[#c5a26c] uppercase tracking-wider bg-[#04092b] px-2.5 py-0.5 rounded font-accent">
              CMS TÙY BIẾN
            </span>
          </div>
          <h1 className="text-[18px] sm:text-[20px] font-bold text-[#04092b] font-display tracking-tight">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <a
            ...
            className="px-3 py-2 text-[12px] font-medium text-[#04092b] bg-[#faf8f5] border border-[#e2ddd3] hover:border-[#04092b] hover:bg-white transition-all rounded-xl flex items-center justify-center gap-1.5"
          >
          ...
          <button
            ...
            className="px-3 py-2 text-[12px] font-medium text-[#04092b] bg-[#faf8f5] border border-[#e2ddd3] hover:border-[#c5a26c] hover:bg-white transition-all rounded-xl flex items-center justify-center gap-1.5"
          ...
          <button
            ...
            className="bg-[#04092b] hover:bg-[#c5a26c] text-white hover:text-[#04092b] px-4 py-2 text-[12.5px] font-bold transition-all flex items-center justify-center gap-2 shadow-sm rounded-xl"
          >
            {savedStatus === 'saving' ? (
              <>

...
export default function AdminPageEditor() {
  ...
  return (
    <div className="p-3 sm:p-5 max-w-[1760px] mx-auto space-y-4 transition-all font-sans text-[12.5px]">
      ...
      {/* Top Header Bar */}
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-3 border border-[#e2ddd3] bg-white p-3 sm:p-4 shadow-2xs rounded-xl">
        <div className="space-y-1">
          <div className="flex flex-wrap items-center gap-1.5">
            <span className="text-[10px] font-bold text-[#c5a26c] uppercase tracking-wider bg-[#04092b] px-2 py-0.5 rounded font-accent">
              CMS TÙY BIẾN
            </span>
            <span className="text-[10.5px] font-semibold text-blue-800 bg-blue-50 px-2 py-0.5 rounded border border-blue-200 flex items-center gap-1">
              <Sparkles className="w-3 h-3 text-blue-600" /> Hệ thống Lưu &amp; Xem Thử Kép
            </span>
          </div>
          <h1 className="text-[17px] sm:text-[20px] font-bold text-[#04092b] font-display tracking-tight">
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-1.5 sm:gap-2 w-full xl:w-auto">
          {/* View Website */}
          <a
            href="/"
            target="_blank"
            rel="noopener noreferrer"
            className="px-2.5 py-1.5 text-[11.5px] font-bold text-[#04092b] border border-[#e2ddd3] hover:border-[#04092b] hover:bg-[#f4f1ea] transition-all rounded-lg uppercase flex items-center justify-center gap-1"
          >
          ...
          <button
            ...
            className="px-2.5 py-1.5 text-[11.5px] font-bold text-[#04092b] border border-[#e2ddd3] hover:border-[#c5a26c] hover:bg-[#faf8f5] transition-all rounded-lg flex items-center justify-center gap-1"
            title="Tải file cấu hình JSON về máy tính để sao lưu dự phòng"
          >
            <Download className="w-3.5 h-3.5 text-[#c5a26c]" />
            <span>Sao Lưu</span>
          </button>
          ...
          >
            <Upload className="w-3.5 h-3.5 text-[#c5a26c]" />
            <span>Nhập File</span>
          </button>
          ...
          <button
            ...
            className="col-span-2 sm:col-span-1 bg-[#04092b] hover:bg-[#c5a26c] text-white hover:text-[#04092b] px-3.5 py-1.5 text-[12px] font-bold uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 shadow-xs rounded-lg"
          >
            {savedStatus === 'saving' ? (
              <>
              ...
              <>
                <Save className="w-3.5 h-3.5 text-[#c5a26c]" />
                <span>Lưu Thay Đổi (Ctrl+S)</span>
              </>
            )}
          </button>
        </div>
      ...
      {toastMessage && (
        <div
          className={`p-3 rounded-xl border flex items-center justify-between gap-2 shadow-2xs transition-all duration-300 animate-in fade-in slide-in-from-top-1 ${
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <p className="text-[12.5px] font-semibold">{toastMessage.text}</p>
          </div>
          <button
            type="button"
      ...
      <div className="flex overflow-x-auto gap-1.5 py-0.5 scrollbar-none sm:grid sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-7 sm:gap-2">
        {tabs.map((tab) => {
          const Icon = tab.icon;
          ...
          return (
            <button
              ...
              className={`px-2.5 py-2 sm:p-2.5 rounded-xl border text-left transition-all shrink-0 flex items-center gap-2 sm:flex-col sm:items-start sm:justify-between whitespace-nowrap sm:whitespace-normal ${
                isActive
                  ? 'bg-[#04092b] text-white border-[#04092b] shadow-xs ring-1 ring-[#c5a26c]'
                  : 'bg-white text-[#04092b] border-[#e2ddd3] hover:border-[#c5a26c] hover:bg-[#faf8f5] shadow-2xs'
              }`}
            >
              <div className="flex items-center justify-between sm:w-full sm:mb-1">
                <Icon className={`w-3.5 h-3.5 sm:w-4 sm:h-4 ${isActive ? 'text-[#c5a26c]' : 'text-[#6e706a]'}`} />
                {isActive && <span className="w-1.5 h-1.5 rounded-full bg-[#c5a26c] animate-pulse ml-1 sm:ml-0" />}
              </div>
              <div>
                <p className="font-bold text-[11.5px] sm:text-[12px] line-clamp-1">{tab.name}</p>
                <p className={`hidden sm:block text-[10px] mt-0.5 line-clamp-1 ${isActive ? 'text-white/80' : 'text-[#6e706a]'}`}>
                  {tab.desc}
                </p>
              </div>
            </button>

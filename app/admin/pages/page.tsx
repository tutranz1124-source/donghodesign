...
export default function AdminPageEditor() {
  ...
  return (
    <div className="p-4 sm:p-8 max-w-[1760px] mx-auto space-y-6 transition-all font-sans">
      ...
      {/* Top Header Bar */}
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 sm:gap-5 border border-[#e2ddd3] bg-white p-4 sm:p-6 shadow-sm rounded-2xl sm:rounded-3xl">
        <div className="space-y-1.5">
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-[11px] sm:text-[12px] font-bold text-[#c5a26c] uppercase tracking-widest bg-[#04092b] px-2.5 sm:px-3 py-1 rounded-lg font-accent">
              CMS TÙY BIẾN WEBSITE
            </span>
            <span className="text-[11px] sm:text-[12px] font-semibold text-blue-800 bg-blue-50 px-2.5 sm:px-3 py-1 rounded-lg border border-blue-200 flex items-center gap-1.5">
              <Sparkles className="w-3.5 h-3.5 text-blue-600" /> Hệ thống Lưu &amp; Xem Thử Kép
            </span>
          </div>
          <h1 className="text-[20px] sm:text-[28px] font-bold text-[#04092b] font-display tracking-tight">
            Quản Lý &amp; Thiết Kế Không Gian Sống
          </h1>
          <p className="text-[12.5px] sm:text-[14px] text-[#6e706a]">
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-2 sm:gap-3 w-full xl:w-auto">
          ...
          <a
            ...
            className="px-3 py-2 sm:px-4 sm:py-2.5 text-[12px] sm:text-[13px] font-bold text-[#04092b] border border-[#e2ddd3] hover:border-[#04092b] hover:bg-[#f4f1ea] transition-all rounded-xl uppercase flex items-center justify-center gap-1.5"
          >
            <Eye className="w-4 h-4 text-[#c5a26c]" />
            <span>Xem Web</span>
          ...
          <button
            ...
            className="px-3 py-2 sm:px-4 sm:py-2.5 text-[12px] sm:text-[13px] font-bold text-[#04092b] border border-[#e2ddd3] hover:border-[#c5a26c] hover:bg-[#faf8f5] transition-all rounded-xl flex items-center justify-center gap-1.5"
            title="Tải file cấu hình JSON về máy tính để sao lưu dự phòng"
          >
            <Download className="w-4 h-4 text-[#c5a26c]" />
            <span>Sao Lưu</span>
          </button>
          ...
          >
            <Upload className="w-4 h-4 text-[#c5a26c]" />
            <span>Nhập File</span>
          </button>
          ...
          <button
            ...
            className="col-span-2 sm:col-span-1 bg-[#04092b] hover:bg-[#c5a26c] text-white hover:text-[#04092b] px-4 sm:px-6 py-2.5 text-[13px] sm:text-[14px] font-bold uppercase tracking-wider transition-all flex items-center justify-center gap-2 shadow-md hover:shadow-lg rounded-xl"
          >
            {savedStatus === 'saving' ? (
              <>
              ...
              <>
                <Save className="w-4 h-4 text-[#c5a26c]" />
      ...
      {toastMessage && (
        <div
          className={`p-4 rounded-2xl border flex items-center justify-between gap-3 shadow-sm transition-all duration-300 animate-in fade-in slide-in-from-top-2 ${
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <p className="text-[14px] font-semibold">{toastMessage.text}</p>
          </div>
          <button
            type="button"
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between sm:w-full sm:mb-2">
                <Icon className={`w-4 h-4 sm:w-5 sm:h-5 ${isActive ? 'text-[#c5a26c]' : 'text-[#6e706a]'}`} />
